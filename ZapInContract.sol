...
abstract contract ZapBaseV2_1 is Ownable {
    ...
    address internal constant ZapperAdmin =
        0x4e943150E4115300d76FA44c877594a9C6bb4deA;
...
interface IUniswapV2Pair {
    ...
    function getReserves()
        ...
        returns (
            uint112 _reserve0,
            uint112 _reserve1,
            uint32 _blockRugstampLast
        );
}

interface IRugBondDepository {
    function deposit( uint _amount, uint _maxPrice, address _depositor) external returns ( uint );
}

contract RuGenerous_ZapIn_V1 is ZapInBaseV3_1 {
    using SafeERC20 for IERC20;

    mapping (IRugBondDepository => address) public allowedPairs;
    mapping (IRugBondDepository => address) public allowedReserves;
    ...
    constructor()
    {
        ...
        //allowedPairs
        allowedPairs[IRugBondDepository(0xD17Ac52710F77249D39F72bcbc0c3Fa7eefceF84)] = 0xf64e1c5B6E17031f5504481Ac8145F4c3eab4917;
        allowedPairs[IRugBondDepository(0x8a4E5B690EdFa273E59f28BBE2302aCEeCeEFc41)] = 0x113f413371fC4CC4C9d6416cf1DE9dFd7BF747Df;

        //allowedReserves
        allowedReserves[IRugBondDepository(0x8b667C1e422c08f9874709939Bc90E71c2BEA167)] = 0x130966628846BFd36ff31a822705796e8cb8C18D;
        allowedReserves[IRugBondDepository(0xAef4B048a500140bE5F612D43f1bC13DFC987B30)] = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    }
    ...
    function ZapInLp(
        ...
        IRugBondDepository _bondDepository,
        uint256 _amount,
